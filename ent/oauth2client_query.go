...
func (oq *OAuth2ClientQuery) FirstIDX(ctx context.Context) int {
...
func (oq *OAuth2ClientQuery) IDs(ctx context.Context) (ids []int, err error) {
...
//		GroupBy(oauth2client.FieldClientID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.OAuth2Client.Query().
//		Select(oauth2client.FieldClientID).
//		Scan(ctx, &v)
...
func (oq *OAuth2ClientQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(oauth2client.Table, oauth2client.Columns, sqlgraph.NewFieldSpec(oauth2client.FieldID, field.TypeInt))
	_spec.From = oq.sql
